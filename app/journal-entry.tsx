...
import PromptSelector from '@/components/Journal/PromptSelector';
import SelectedPromptDisplay from '@/components/Journal/SelectedPromptDisplay';
...
const moodTags = [
    '😊 Feliz', '😌 Calmo', '😴 Cansado', '😰 Ansioso',
    '😢 Triste', '😠 Irritado', '🤗 Grato', '💪 Motivado',
    '🤯 Estressado', '😍 Apaixonado', '🙄 Entediado', '😎 Confiante'
];
...
export default function JournalEntryScreen() {
    ...
    const updateUserStats = async () => {
        try {
            ...
            const updatedStats = {
                ...currentStats,
                totalJournalEntries: (currentStats.totalJournalEntries || 0) + 1,
                lastJournalEntry: today,
                journalStreak: currentStats.lastJournalEntry === today
                    ? currentStats.journalStreak || 1
                    : (currentStats.journalStreak || 0) + 1,
            };
